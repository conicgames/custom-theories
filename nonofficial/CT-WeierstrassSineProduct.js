...
var init = () => {
    ...
    // q1
    {
        ...
        q1 = theory.createUpgrade(0, currency, new FirstFreeCost(new ExponentialCost(10, 3.36843/4)));
    ...
    // q2
    {
        ...
        q2 = theory.createUpgrade(1, currency, new ExponentialCost(1000, 3.36843*3));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(4, currency, new ExponentialCost(1e10, 3.36843*10));
    ...
    /////////////////////
    // Checkpoint Upgrades
    theory.setMilestoneCost(new CustomCost(lvl => BigNumber.from(lvl < 5 ? 1 + lvl : 10)));

    {
        q1Exp = theory.createMilestoneUpgrade(0, 2);
