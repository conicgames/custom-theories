...
Вы начинаете присматриваться к экспонентам ω и x.
Точно! Их повышение было бы хорошей идеей для продолжения прогресса.
Настало время старого трюка с экспонентами.`,
...
Ещё остались переменные, с чьими экспонентами можно повозиться...`,
