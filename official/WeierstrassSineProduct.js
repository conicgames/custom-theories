...
Интуитивно, идея, стоящая за этой формулой - факторизовать синус при помощи его корней (синус имеет свои корни в каждом числе, кратном π) точно так же, как это можно сделать для многочлена.
