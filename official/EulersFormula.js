...
Можете поиграть в другую пользовательскую теорию, которая вышла в этом же обновлении: "Приближение корня из двух" ("Convergents to sqrt(2)") после того, как сыграете в эту, если ещё не играли!
